...
export const metadata: Metadata = {
  ...
  description: "Terms of service for the Claudict Recovery Center.",
};
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-16">
      ...
      <div className="space-y-10 text-sm leading-relaxed text-text/90">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-3">2. Nature of the service</h2>
          <p>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-3">4. User-generated content</h2>
          <p className="mb-2">
        ...
        <section>
          <h2 className="text-lg font-semibold mb-3">5. Prohibited content</h2>
        ...
        <section>
          <h2 className="text-lg font-semibold mb-3">6. Content moderation</h2>
          <p>
